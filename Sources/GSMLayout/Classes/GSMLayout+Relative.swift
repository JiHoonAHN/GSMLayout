...
extension GSMLayout {
    ...
    //
    @discardableResult
    public func above(of relativeView: View, aligned: HorizontalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func above(of relativeViews: [View], aligned: HorizontalAlign = .none) -> GSMLayout {
    ...
    //
    @discardableResult
    public func below(of relativeView: View, aligned: HorizontalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func below(of relativeViews: [View], aligned: HorizontalAlign = .none) -> GSMLayout {
    ...
    //
    @discardableResult
    public func left(of relativeView: View, aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func left(of relativeViews: [View], aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    //
    @discardableResult
    public func right(of relativeView: View, aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func right(of relativeViews: [View], aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    //
    @discardableResult
    public func before(of relativeView: View, aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func before(of relativeViews: [View], aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    //
    @discardableResult
    public func after(of relativeView: View, aligned: VerticalAlign = .none) -> GSMLayout {
    ...
    @discardableResult
    public func after(of relativeViews: [View], aligned: VerticalAlign = .none) -> GSMLayout {
...
// MARK: private
extension GSMLayout {
    fileprivate func above(of relativeViews: [View], aligned: HorizontalAlign, context: Context) -> GSMLayout {
    ...
    fileprivate func below(of relativeViews: [View], aligned: HorizontalAlign, context: Context) -> GSMLayout {
        guard let relativeViews = validateRelativeViews(relativeViews, context: context) else { return self }
    ...
    fileprivate func left(of relativeViews: [View], aligned: VerticalAlign, context: Context) -> GSMLayout {
        guard let relativeViews = validateRelativeViews(relativeViews, context: context) else { return self }
    ...
    fileprivate func right(of relativeViews: [View], aligned: VerticalAlign, context: Context) -> GSMLayout {
        guard let relativeViews = validateRelativeViews(relativeViews, context: context) else { return self }
